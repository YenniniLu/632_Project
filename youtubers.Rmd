...
Do a sentiment analysis on the subtitles and find the best model to predict the number of views using Subscribers, CC, Released, Category, Sentiment and Length.

## Data Cleaning

We notice several problems in the data, like:     
...
boxplot(df$Subscribers)

pairs(Views ~ CC + Released + Length + Subscribers, data=df)
```
